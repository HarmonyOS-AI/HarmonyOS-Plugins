...
| --- | --- |
| `harmonyos-dev-toolkit/skills/harmonyos-live-preview/` | 驱动命令、多设备、桥接会话、尺寸解析与运行时 resize；详见 [live-preview 评测](plugins/harmonyos-dev-toolkit/skills/harmonyos-live-preview/README.md)。 |
